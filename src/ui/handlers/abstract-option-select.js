...
export class AbstractOptionSelectUiHandler extends UiHandler {
  optionSelectContainer;
  optionSelectTextContainer;
  optionSelectBg;
  optionSelectText;
  optionSelectIcons;
  ...
  clear() {
    super.clear();
    this.config = null;
    //this.optionSelectContainer = null;
    this.fullCursor = 0;
    this.scrollCursor = 0;
    this.eraseCursor();
  }
