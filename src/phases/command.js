...
export class CommandPhase extends FieldPhase {
   ...
   */
  computeMoveId(playerPokemon, cursor, move) {
  ...
  handleFightCommand(
    ...
    const turnCommand = {
      command: Command.FIGHT,
      cursor,
      move: { move, targets: [], useMode },
      args: [useMode, move],
    };
    const preTurnCommand = {
      command,
   ...
   */
  tryLeaveField(cursor, isBatonSwitch = false) {
