...
export class EvolutionPhase extends Phase {
  ...
  evolution
  fusionSpeciesEvolved // Whether the evolution is of the fused species
  evolutionBgm
  evolutionHandler
   ...
   */
  constructor(pokemon, evolution, lastLevel, canCancel = true) {
    super();
   ...
   *
   */
  setupEvolutionAssets(){
    this.evolutionHandler = globalScene.ui.getHandler();
   ...
   */
  configureSprite(pokemon, sprite, setPipeline = true) {
   ...
   */
  updateEvolvedPokemonSprites(evolvedPokemon){
   ...
   */
  playEvolutionAnimation(evolvedPokemon){
  ...
  fadeOutPokemonSprite(evolvedPokemon){
   ...
   */
  prepareForCycle(evolvedPokemon){
   ...
   */
  showPauseEvolutionConfirmation(endCallback){
   ...
   */
  showFailedEvolutionUI(evolvedPokemon){
   ...
   * @param evolvedPokemon - The evolved Pokemon
   */
  handleFailedEvolution(evolvedPokemon){
   ...
   */
  onEvolutionComplete(evolvedPokemon) {
    if (this.evolutionBgm) {
      SoundFade.fadeOut(globalScene, this.evolutionBgm, 100);
    }
   ...
   * @param evolvedPokemon - The evolved Pokemon
   */
  handleSuccessEvolution(evolvedPokemon){
