...
export class EggHatchPhase extends Phase {
  ...
  constructor(hatchScene, egg, eggsToHatchCount) {
    super();
  ...
  start() {
    ...
    globalScene.ui.setModeForceTransition(UiMode.EGG_HATCH_SCENE).then(() => {
      ...
      this.eggHatchHandler = globalScene.ui.getHandler();
   ...
   */
  doEggShake(intensity, repeatCount, count) {
   ...
   */
  doSprayParticle(trigIndex, offsetY) {
