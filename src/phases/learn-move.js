...
export class LearnMovePhase extends PlayerPartyMemberPokemonPhase {
  ...
  constructor(
    partyMemberIndex,
    moveId,
    learnMoveType = LearnMoveType.LEARN_MOVE,
    cost = -1,
  ) {
   ...
   */
  async replaceMoveCheck(move, pokemon) {
   ...
   * @param Pokemon The Pokemon learning the move
   */
  async forgetMoveProcess(move, pokemon) {
    globalScene.ui.setMode(this.messageMode);
   ...
   * @param Pokemon The Pokemon learning the move
   */
  async rejectMoveAndEnd(move, pokemon) {
   ...
   * @param Pokemon The Pokemon learning the move
   */
  async learnMove(index, move, pokemon, textMessage) {
