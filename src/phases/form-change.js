...
import { EvolutionPhase } from "./evolution.js";
...
export class FormChangePhase extends EvolutionPhase {
  ...
  constructor(pokemon, formChange, modal) {
   ...
   */
  postFormChangeTweens(transformedPokemon, preName) {
   ...
   */
  afterCycle(preName, transformedPokemon) {
   ...
   * @param transformedPokemon The Pokemon after the evolution
   */
  beginTweens(preName, transformedPokemon) {
    globalScene.tweens.chain({
    ...
    if (this.modal) {
      globalScene.ui.revertMode().then(() => {
        if (globalScene.ui.getMode() === UiMode.PARTY) {
          const partyUiHandler = globalScene.ui.getHandler();
