...
//current pokemon need to be 2 times faster to have 100% chance to escape
//Ability Run Away double the chances, while Arena Trap and Shadow Tag decrease it

import { globalScene } from "../global-scene.js";
import { FieldPhase } from "./field.js";

//Same speed is 50% chance
export class AttemptRunPhase extends FieldPhase {
  phaseName = "AttemptRunPhase";
   ...
   */
  calculateEscapeChance(escapeAttempts) {
