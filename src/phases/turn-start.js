...
//Should big rework here, 
//separed the speed handle (before command) and the choices (after command)
export class TurnStartPhase extends FieldPhase {
  phaseName = "TurnStartPhase";
  ...
  getCommandOrder() {
    ...
    const orderedTargets = playerField.concat(enemyField);
  ...
  start() {
    ...
    //this should be in command phase
    ...
    moveOrder.forEach((o, index) => {
      ...
      //phase should end here, go to set the order of each pokemon and call another phase
  ...
  handleTurnCommand(turnCommand, pokemon) {
    switch (turnCommand?.command) {
      case Command.FIGHT:
        this.handleFightCommand(turnCommand, pokemon);
        break;
      case Command.BALL:
        //keep this cause it's gonna be items in the future
  ...
  handleFightCommand(turnCommand, pokemon) {
