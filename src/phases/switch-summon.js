...
export class SwitchSummonPhase extends SummonPhase {
   ...
   */
  constructor(switchType, fieldIndex, slotIndex, doReturn, player = true) {
      ...
      if (
        !globalScene.findModifier(
          m =>
            ...
            && (m).pokemonId === switchedInPokemon.id,
        )
      ) {
        const batonPassModifier = globalScene.findModifier(
          m =>
            m instanceof SwitchEffectTransferModifier
            && (m).pokemonId === this.lastPokemon.id,
        );
   ...
   */
  getSendOutText(switchedInPokemon) {
